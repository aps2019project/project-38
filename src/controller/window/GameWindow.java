...
//            game.getSelectionManager().deselectAll();
...
//            game.getSelectionManager().selectSpecialPower(game);
//        } else {
...
//            return;
//        }
//        if (game.getSelectionManager().collectibleItem != null) {
//            if (game.useCollectible(game.getSelectionManager().collectibleItem, cell)) {
...
//        if (game.getSelectionManager().cardHandIndex != null) {
//            if (game.replaceCard(game.getSelectionManager().cardHandIndex)) {
...
//        }
//        if (game.getSelectionManager().cardHandIndex != null) {
//            if (game.useCard(game.getSelectionManager().cardHandIndex, cell)) {
...
//                game.getSelectionManager().selectCard(game, index);
...
//                    game.getSelectionManager().selectCollectibleItem(game.getActivePlayer().getCollectibleItems().get(index));
...
//    }
//
//    private void selectCell(String request) {
//        Cell cell = getCellByMessage(request);
//        if (cell == null) {
//            return;
//        }
